...
const TimelineItem = ({ date, title, body, tools, end }: Props) => {
    const icons = tools.split(",").map((e) => useIcon(e.trim()));
    return <li>
        ...
        <div className={`${!end === true ? "timeline-start" : "timeline-end"} md:text-end mb-10`}>
